      ...
      <div className={styles.mainPageCont}>
        ...
        <div className={styles.matnCont}>
          <p>
            ...
            <span style={{ textAlign: "center", fontSize: "14px" }}>📢 خیلی راحت! مشتری بیار، پول ببر! 💰😍</span>
          </p>
          <p
          ...
          <div style={{ width: "100%" }}>
            <p style={{ textAlign: "right" , fontSize: "13px" }}>1️⃣ مشتریت میاد چاپخونه و سفارشش رو ثبت می‌کنه.</p>
            <p style={{ textAlign: "right" , fontSize: "13px" }}>2️⃣ اسم تو رو به‌عنوان معرف میگه.</p>
          ...
          <p style={{fontSize: "15px", marginTop: "5px"}}>🔥 یه فرصت طلایی برای کسب درآمد! 🔥</p>
